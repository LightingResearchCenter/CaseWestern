function [time, lux, CLA, activity, temp, x, y] = process_raw_dime_09Aug2011(rawfilename, id, varargin)
...
[cal, chrom, time, red, green, blue, activity] = read_raw_dime_08Jun2011(rawfilename, id);
